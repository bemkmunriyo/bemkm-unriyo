            ...
            <div class="relative z-10">
                ...
                <div class="mb-14">
                    ...
                    <div class="inline-flex items-center bg-white/10 px-4 py-2 rounded-full text-sm font-medium mb-6">
                        Dashboard Organisasi Mahasiswa dan Unit Kegiatan Mahasiswa
                    </div>
                    ...
                    <p class="text-lg text-blue-100 leading-relaxed">
                        ...
                        Platform digital pengajuan proposal, LPJ, dan
                        administrasi organisasi secara modern dan terintegrasi.
